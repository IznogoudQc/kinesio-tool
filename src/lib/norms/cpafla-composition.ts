...
const MEN: ImcBand[] = [
  { imcLt: 18.5, label: 'moins de 18,5', a: 3, ct: ALL_CT,
    s5pc: [{ from: NEG, inc: true, pts: 3, label: '< 25' }, { from: 25, inc: true, pts: 4, label: '25–55' }, { from: 55, inc: false, pts: 3, label: '> 55–77' }, { from: 77, inc: false, pts: 2, label: '> 77' }] },
...
const WOMEN: ImcBand[] = [
  { imcLt: 18.5, label: 'moins de 18,5', a: 3, ct: ALL_CT,
    s5pc: [{ from: NEG, inc: true, pts: 3, label: '< 46' }, { from: 46, inc: true, pts: 4, label: '46–84' }, { from: 84, inc: false, pts: 3, label: '> 84–113' }, { from: 113, inc: false, pts: 2, label: '> 113' }] },
  { imcLt: 25, label: '18,5–24,9', a: 4,
